        ...
        >
          <Flex justifyContent="space-between" width="100%">
            ...
            <VStack align="start" spacing={1}>
              ...
              <Heading as="h5" size="sm">{data.methodName}</Heading>
              <Flex>
            ...
            <VStack align="end" spacing={1}>
              <Flex width="100%">
                <Button size="sm" flex="1" onClick={() => moveItemUp(index)}>Up</Button>
                <Button size="sm" flex="1" onClick={() => moveItemDown(index)}>Down</Button>
              </Flex>
              <Button bg={removeItemColor}  size="md" width="100%" onClick={() => removeFromPlaylist(data.uniqueId)}>Remove</Button>
            </VStack>
          </Flex>
        </ListItem>
      ))}
